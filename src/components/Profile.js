...
const [updatedUserData, setUpdatedUserData] = useState({
  ...
  mobile: userData?.mobile || "",         // keep for display, but we'll not allow edits
  vehicleType: userData?.vehicleType || "",
  vehicleNumber: userData?.vehicleNumber || userData?.vehicleReg || "", // fallback keys if legacy
});
        ...
        {userData ? (
          <>
            {isEditing ? (
              ...
              <div style={styles.cardContainer}>
                ...
                <div style={styles.infoCard}><span style={styles.cardLabel}>Email</span><span style={styles.cardValue}>{userData.email || "Not provided"}</span></div>
                ...
                <div style={styles.infoCard}><span style={styles.cardLabel}>Vehicle Number</span><span style={styles.cardValue}>{userData.vehicleNumber || userData.vehicleReg || "Not provided"}</span></div>
          ...
          <div
            style={{
              ...
              textAlign: "center",  // centers text inside children
            }}
          >
        ...
        {popupVisible && (
          <div style={styles.popupOverlay} onClick={closePopup}>
            <div style={styles.popupBox} onClick={e => e.stopPropagation()}>
              ...
              <p style={{ color: "#04BFBF", cursor: "pointer", textDecoration: "underline" }} onClick={() => {
                closePopup();
                navigate("/operator-form");
              }}>
...
cardContainer: {
  ...
  flexDirection: 'column',
  gap: '5px',
  boxSizing: 'border-box',   // Add this for padding + width control  
  padding: '0 12px',         // Add horizontal padding for mobile fit
  wordBreak: 'break-word',   // Allow line-wrap for long text if needed
},
infoCard: {
  ...
  border: "1px solid rgba(255,255,255,0.06)",
  fontWeight: "normal",             // Make font weight normal here if needed
},
cardLabel: {
  color: "#99c3de",
  fontSize: "13px",
  marginBottom: "0",    // remove bottom margin since same line
},
cardValue: {
  color: "#e6f9ff",
  fontSize: "17px",
  fontWeight: "normal", // Change from 600 to normal for simpler font
},
...
cancelButton: {
  ...
  popupBox: {
    ...
    maxWidth: "300px",    // Width fits content text max size
    color: "#fff",
    position: "relative",
    textAlign: "center",
    whiteSpace: "nowrap",       // Prevent wrapping if you want exact fit, or remove if wrapping is preferred
  },
  popupCloseBtn: {
    position: "absolute",
    top: "10px",
